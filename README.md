...
# Author 
![Screenshot](https://github.com/Saikohackerteamrm/SMS_BOMBER/blob/main/20250805_163827.jpg)
...
____________________
    ...
    $ git clone https://github.com/Saikohackerteamrm/SMS_BOMBER
    $ cd SMS_BOMBER
    $ python Mithila.py
...
_______________________________________
    ...
    apt update -y && apt upgrade -y && pkg install git -y && pkg install python -y  && git clone https://github.com/Saikohackerteamrm/SMS_BOMBER && cd SMS_BOMBER && python Mithila.py
 ### Hi there 👋
